...
@Service
public class EmployeManager implements EmployeManagerInterface {
	...
	@Override
	public Employe AffectationRemplaceur(String Matricule) {
		Employe c = cr.findClientByMatricule(Matricule);
	...
	@Override
	public Employe DesAffectationRemplaceur(String Matricule) {
		Employe c = cr.findClientByMatricule(Matricule);
	...
	@Override
	public List<Employe> retrieveAllClient() {
		return (List<Employe>) cr.findAll();
	...
	@Override
	public Employe FindClientById(long id) {
		return  cr.findById(id).orElse(new Employe());
	}

	@Override
	public Employe FindClientById(String id) {
		return  cr.findById(Long.parseLong(id)).orElse(new Employe());}
	...
	public EmployeManager(EmployeRepository cr, BCryptPasswordEncoder bCryptPasswordEncoder) {
		this.cr = cr;
	...
	@Override
	public Employe SignUpClient(@Valid Employe user) {
	...
	@Override
	public Employe addClient(Employe Cl) {
	...
	public List<User> retriveRemplaceur( String username ) {
		...
		//List<Employe> ListClients = cr.RetiveRemplaceur(Boolean.TRUE);
		/*
		...
		for ( User i: listUserdep ) {
		    ...
		    Employe client = cr.findByIdUser(id);
	...
	@Override
	public List<User> getEmployeeByDepartment (String username){
		System.out.println("username : " + username);
		...
		List<User> list = ur.getUserByIdDep(IdDep);
		return list;
	}
